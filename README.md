...
## 🔍 Why this project?
Traditional RAG pipelines blindly retrieve k documents and feed them to an LLM. This project adds **agentic control loops** and **structured evaluators** so the system can *adapt*:
